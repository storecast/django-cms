...
class Migration:
    ...
    def forwards(self, orm):
        db.delete_unique("snippet_snippet", ("name",))
        db.create_unique("snippet_snippet", ("name", "site_id",))


    def backwards(self, orm):
        db.delete_unique("snippet_snippet", ("name", "site_id",))
        db.create_unique("snippet_snippet", ("name",))
